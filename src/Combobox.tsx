    ...
    <div ref={containerRef} className={`relative ${className}`}>
      <div className="relative">
        <input
          ...
          className="w-full rounded-lg border border-[var(--ui-border)] bg-[var(--ui-surface-hover)] px-3 py-2 text-sm text-[var(--ui-text)] outline-none focus:border-[var(--ui-primary)] transition-colors placeholder:text-[var(--ui-text-muted)] disabled:opacity-50"
        />
        <svg
