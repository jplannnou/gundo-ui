...
function GoogleIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" aria-hidden="true">
      <path
        fill="#EA4335"
        d="M9 3.48c1.69 0 2.85.73 3.5 1.34l2.55-2.49C13.46 0.89 11.43 0 9 0 5.48 0 2.44 2.02.96 4.96l2.91 2.26C4.6 5.05 6.62 3.48 9 3.48z"
      />
      <path
        fill="#4285F4"
        d="M17.64 9.2c0-.64-.06-1.25-.16-1.84H9v3.49h4.84c-.21 1.13-.84 2.08-1.8 2.72l2.91 2.26c1.7-1.57 2.69-3.88 2.69-6.63z"
      />
      <path
        fill="#FBBC05"
        d="M3.87 10.78c-.2-.57-.32-1.17-.32-1.78s.12-1.21.32-1.78L.96 4.96C.35 6.17 0 7.54 0 9s.35 2.83.96 4.04l2.91-2.26z"
      />
      <path
        fill="#34A853"
        d="M9 18c2.43 0 4.47-.8 5.96-2.18l-2.91-2.26c-.8.54-1.86.86-3.05.86-2.38 0-4.4-1.57-5.12-3.74L.96 13.04C2.44 15.98 5.48 18 9 18z"
      />
    </svg>
  );
}
...
export function MagicLinkAuth({
  ...
  subtitle = "Entra en 5 segundos. Sin contraseñas.",
  disclaimer,
  defaultEmail = "",
  forcedState,
  onSent,
    ...
    try {
      ...
      setError(
        err instanceof Error
          ? err.message
          : "No pudimos enviar el email. Reintentá.",
      );
    }
  }
  ...
  return (
    ...
    >
      ...
      {disclaimer && (
        <p className="text-center text-[11px] gu-text-text-muted">
          {disclaimer}
        </p>
      )}
    </div>
